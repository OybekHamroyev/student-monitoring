...
function Card({ className, ...props }) {
    return (_jsx("div", { "data-slot": "card", className: cn('bg-card text-card-foreground flex flex-col gap-6 rounded-[28px] border border-border/70 py-6 shadow-[0_18px_48px_-24px_rgba(36,53,102,0.28)]', className), ...props }));
}
...
function CardTitle({ className, ...props }) {
    return (_jsx("div", { "data-slot": "card-title", className: cn('leading-none font-semibold tracking-[-0.02em]', className), ...props }));
}
